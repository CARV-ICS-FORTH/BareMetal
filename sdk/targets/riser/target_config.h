...
#define	PLAT_SYSRAM_BASE	0x800000400000
#define	PLAT_SYSRAM_SIZE	2 * GB

#define PLAT_ROM_BASE		0x800000000000
...
#define PLAT_CLINT_BASE		0x2000000

/* MTIMER frequency in Hz, set to 0 to disable */
#define	PLAT_MTIMER_FREQ	32768
...
#define PLAT_PLIC_BASE		0xc000000
#define PLIC_MAX_PRIORITY	7
#define PLAT_APLIC_BASE		0
#define PLAT_NUM_IRQ_SOURCES	0x14
...
//	{ .hart_id = 1, .target = { .ctx_idx = 2 } },  /* Hart 1 -> Context 2 (M-mode) */
//	{ .hart_id = 2, .target = { .ctx_idx = 4 } },  /* Hart 2 -> Context 4 (M-mode) */
//	{ .hart_id = 3, .target = { .ctx_idx = 6 } },  /* Hart 3 -> Context 6 (M-mode) */
});
#endif
...
/*---=== UART ===---*/
#define PLAT_UART_BASE		0x40010000000
#define PLAT_UART_CLOCK_HZ	50000000
#define PLAT_UART_BAUD_RATE	115200
#define PLAT_UART_REG_SHIFT	2
#define	PLAT_UART_SHIFTED_IO	1
#define PLAT_UART_IRQ		1


/*---=== EMACLITE NIC ==---*/
//#define PLAT_EMACLITE_BASE_ADDR 0x40011000000ULL

/*---=== AXIDMA NIC (CARVNET) ===---*/
#define PLAT_AXIDMA_BASE_ADDR	0x40011010000ULL
//#define PLAT_AXIDMA_BASE_ADDR	0x40011000000ULL
