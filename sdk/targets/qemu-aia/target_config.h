...
#define	PLAT_MTIMER_FREQ	10000000
...
#define PLAT_APLIC_BASE		0xc000000
#define PLAT_NUM_IRQ_SOURCES	96
...
#define PLAT_IMSIC_BASE		0x24000000
...
DEFINE_PLATFORM_INTC_MAP({
	{ .hart_id = 0, .target = { .hart_idx = 0 } },  /* Hart 0 -> APLIC hart index 0 */
	{ .hart_id = 1, .target = { .hart_idx = 1 } },  /* Hart 1 -> APLIC hart index 1 */
	{ .hart_id = 2, .target = { .hart_idx = 2 } },  /* Hart 2 -> APLIC hart index 2 */
	{ .hart_id = 3, .target = { .hart_idx = 3 } },  /* Hart 3 -> APLIC hart index 3 */
});
#endif
...
/*---=== VIRTIO Net ===---*/
#define PLAT_VIRTIO_NET_BASE_ADDR 0x10008000	/* QEMU virt default */
